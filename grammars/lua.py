...
ctx.rule(u'STATEMENT',u'do{PROGRAM}end')
...
ctx.rule(u'FUNCTION',u'{FUNCDEF} ({FUNCTION_ARGS}){PROGRAM}end')
...
ctx.rule(u'CONDITIONAL',u'if {EXPR} then{PROGRAM}end')
ctx.rule(u'CONDITIONAL',u'if {EXPR} then{PROGRAM}{ELSEIF}\nelse{PROGRAM}end')
ctx.rule(u'CONDITIONAL',u'if {EXPR} then{PROGRAM}{ELSEIF}\nend')

ctx.rule(u'ELSEIF',u'\nelseif\n{EXPR} then{PROGRAM}{ELSEIF}')
ctx.rule(u'ELSEIF',u'')

ctx.rule(u'LOOP',u'while {EXPR}\ndo{PROGRAM}end')
ctx.rule(u'LOOP',u'for {NAME} = {EXPR}, {EXPRLIST}\ndo{PROGRAM}end')
ctx.rule(u'LOOP',u'for {NAMELIST} in {EXPRLIST}\ndo{PROGRAM}end')
ctx.rule(u'LOOP',u'repeat{PROGRAM}until {EXPR}')
