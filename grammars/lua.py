...
ctx.rule(u'DECIMAL',u'{DECIMALDIGIT}{DECIMALDIGITS}{EXPONENT}{SIGN}{DECIMALDIGIT}{DECIMALDIGITS}')
ctx.rule(u'DECIMAL',u'{DECIMALDIGIT}{DECIMALDIGITS}.{DECIMALDIGIT}{DECIMALDIGITS}')
ctx.rule(u'DECIMAL',u'{DECIMALDIGIT}{DECIMALDIGITS}.{DECIMALDIGIT}{DECIMALDIGITS}{EXPONENT}{SIGN}{DECIMALDIGIT}{DECIMALDIGITS}')

ctx.rule(u'HEXADECIMAL',u'{HEXDIGIT}{HEXDIGITS}')
ctx.rule(u'HEXADECIMAL',u'{HEXDIGIT}{HEXDIGITS}{BIN_EXPONENT}{SIGN}{DECIMALDIGIT}{DECIMALDIGITS}')
ctx.rule(u'HEXADECIMAL',u'{HEXDIGIT}{HEXDIGITS}.{HEXDIGIT}{HEXDIGITS}')
ctx.rule(u'HEXADECIMAL',u'{HEXDIGIT}{HEXDIGITS}.{HEXDIGIT}{HEXDIGITS}{BIN_EXPONENT}{SIGN}{DECIMALDIGIT}{DECIMALDIGITS}')
