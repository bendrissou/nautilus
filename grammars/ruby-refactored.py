...
ctx.rule(u'BLOCK', u'{CALL} do {BLOCK_VAR_OPT} {COMPSTMT} end')
ctx.rule(u'BLOCK', u'{STMT} if {EXPR}')
ctx.rule(u'BLOCK', u'{STMT} while {EXPR}')
ctx.rule(u'BLOCK', u'{STMT} unless {EXPR}')
ctx.rule(u'BLOCK', u'{STMT} until {EXPR}')
ctx.rule(u'BLOCK', u'BEGIN \{{COMPSTMT}\}')
ctx.rule(u'BLOCK', u'END \{{COMPSTMT}\}')
ctx.rule(u'BLOCK', u'{LHS} = {COMMAND} do {BLOCK_VAR_OPT} {COMPSTMT} end')
ctx.rule(u'BLOCK', u'{LHS} = {COMMAND}')
...
ctx.rule(u'ARG', u'{ARG} {ARG_BIN_OP} {ARG}')
ctx.rule(u'ARG', u'{ARG_UN_OP} {ARG}')
...
ctx.rule(u'PRIMARY', u'{PRIMARY_LONG}')
ctx.rule(u'PRIMARY', u'::{IDENTIFIER}')


ctx.rule(u'PRIMARY_LONG', u'({COMPSTMT})')
ctx.rule(u'PRIMARY_LONG', u'{PRIMARY}::{IDENTIFIER}')
ctx.rule(u'PRIMARY_LONG', u'{PRIMARY} [{ARGS_OPT}]')
ctx.rule(u'PRIMARY_LONG', u'[{ARGS_OPT}]')
ctx.rule(u'PRIMARY_LONG', u'return {CALL_ARGS_BRACKETS_OPT}')
ctx.rule(u'PRIMARY_LONG', u'yield {CALL_ARGS_BRACKETS_OPT}')
ctx.rule(u'PRIMARY_LONG', u'defined? ({ARG})')
ctx.rule(u'PRIMARY_LONG', u'{FUNCTION}')
ctx.rule(u'PRIMARY_LONG', u'{FUNCTION} \{{BLOCK_VAR_OPT} {COMPSTMT}\}\n')
ctx.rule(u'PRIMARY_LONG', u'if {EXPR} {THEN}\n{COMPSTMT}\n{ELSIF_REP} {ELSE_OPT} end\n')
ctx.rule(u'PRIMARY_LONG', u'unless {EXPR} {THEN} {COMPSTMT} {ELSE_OPT} end\n')
ctx.rule(u'PRIMARY_LONG', u'while {EXPR} {DO} {COMPSTMT} end\n')
ctx.rule(u'PRIMARY_LONG', u'until {EXPR} {DO} {COMPSTMT} end\n')
ctx.rule(u'PRIMARY_LONG', u'case {COMPSTMT} when {WHEN_ARGS} {THEN} {COMPSTMT} {ELSE_OPT} end\n')
ctx.rule(u'PRIMARY_LONG', u'for {BLOCK_VAR} in {EXPR} {DO} {COMPSTMT} end\n')
ctx.rule(u'PRIMARY_LONG', u'begin {COMPSTMT} {RESCUE_OPT} {ELSE_OPT} {ENSURE_OPT} end\n')
ctx.rule(u'PRIMARY_LONG', u'class {IDENTIFIER} {INHERITANCE_OPT} {COMPSTMT} end\n')
ctx.rule(u'PRIMARY_LONG', u'module {IDENTIFIER} {COMPSTMT} end\n')
ctx.rule(u'PRIMARY_LONG', u'def {FNAME} {ARGDECL} {COMPSTMT} end\n')
ctx.rule(u'PRIMARY_LONG', u'def {SINGLETON} {DOTS} {FNAME} {ARGDECL} {COMPSTMT} end\n')
